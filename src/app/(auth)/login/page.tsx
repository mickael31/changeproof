...
function SSOButton({ provider, loading, label, onClick }: { provider: SSOProvider; loading: boolean; label: string; onClick: () => void }) {
  return (
    <Button
      variant="outline"
      className="w-full"
...
export default function LoginPage() {
  ...
  const enabledProviders = ssoProviders.filter(
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-950 dark:to-blue-950 p-4">
